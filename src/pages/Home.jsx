            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-600 leading-relaxed text-lg">
                  "We are building a clean energy future by providing smart, practical, and reliable solar energy solutions bridging technology and sustainability and empowering every home and business to be self-reliant in generating it's own energy"
                </p>
              </div>
            </motion.div>
          </div>
